...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-700 p-1', className)}
    {...props}
  />
));
