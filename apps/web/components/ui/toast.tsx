  ...
  'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border p-4 pr-8 shadow-lg transition-all',
  {
    variants: {
      variant: {
        ...
        destructive: 'destructive border-red-500 bg-red-50 dark:bg-red-900/20 text-red-600',
        success: 'border-green-500 bg-green-50 dark:bg-green-900/20 text-green-700',
      },
    },
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ref={ref}
    className={cn('inline-flex shrink-0 items-center justify-center rounded-lg px-3 py-1.5 text-sm font-medium', className)}
    {...props}
  />
));
